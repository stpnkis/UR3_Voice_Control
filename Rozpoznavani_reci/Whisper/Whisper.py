# Část tohoto kódu je převzata z repozitáře dostupného na adrese:
# Davabase. (2024). Whisper real-time. GitHub repository. https://github.com/davabase/whisper_real_time
